...
This repository includes the JAVASCRIPT SDK for API v6 of Zoho CRM. Check [Versions](https://github.com/zoho/zohocrm-javascript-sdk-6.0/releases) for more details on the versions of SDK released for this API version.
...
For older versions, please [refer](https://github.com/zoho/zohocrm-javascript-sdk-6.0/releases).
